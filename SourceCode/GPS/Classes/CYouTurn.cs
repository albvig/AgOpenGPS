...
namespace AgOpenGPS
{
    public class CYouTurn
    {
        ...
        public bool isDoingWideTurn = false;
        ...
        public bool BuildCurveDubinsYouTurn(bool isTurnLeft)
        {
            ...
            {
                isDoingWideTurn = true;
                return CreateCurveWideTurn(isTurnLeft);
            }
            ...
            else
            {
                if (uTurnStyle == 0)
                {
                    return CreateCurveOmegaTurn(isTurnLeft);
                }
        ...
        private bool CreateCurveOmegaTurn(bool isTurnLeft)
        {
            //grab the vehicle widths and offsets
        ...
        private bool CreateCurveWideTurn(bool isTurnLeft)
        {
        ...
        public void YouTurnTrigger()
        {
            ...
            if (uTurnStyle == 0 || isDoingWideTurn)
            {
        ...
        public void DrawYouTurn()
        {
            ...
            GL.Color3(0.53f, 0.43f, 0.33f);
            GL.Vertex3(closestTurnPt.closePt.easting, closestTurnPt.closePt.northing, 0);
            GL.End();
            GL.PointSize(1.0f);
